           ...
           <li class="sidebar-menu-item active open">
               <a class="sidebar-menu-button"
                  ...
                  @can('admin_panel_access')
                   ...
                   <span class="sidebar-menu-text">Users Managment</span>
                   <span class="ml-auto sidebar-menu-toggle-icon"></span>
               </a>
               @endcan
               @canany(['users_access','roles_access','permissions_access'])
               <ul aria-expanded="false" class="sidebar-submenu collapse show collapse first-level   @if(request()->is('admin/users') || request()->is('admin/users/*')) in @endif
